...
## Do p-value < 2.2*10^(-16) < 0.05 => có cơ sở bác bỏ H0
## H1: đúng

# Dùng hàm HotellingsT2 để kiểm định GTTB của (HRT1, COT1, SVRIT1, PWVT1) có thực sự khác (HRT4, COT4, SVRIT4, PWVT4)
HotellingsT2(data.frame(LASERI$HRT1, LASERI$COT1, LASERI$SVRIT1, LASERI$PWVT1), data.frame(LASERI$HRT4, LASERI$COT4, LASERI$SVRIT4, LASERI$PWVT4))
## Do p-value < 2.115*10^(-6) < 0,05 => có cơ sở bác bỏ H0
## H1 đúng